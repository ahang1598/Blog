...
创建表并插入语句 `create table t(id int); insert into t values(1),(2),(null);`

<img src="C:\java\markdown\docs\img\MySQL\wpsAF4C.tmp.jpg" alt="img" style="zoom:67%;" /> 

 

<img src="C:\java\markdown\docs\img\MySQL\wpsAF4D.tmp.jpg" alt="img" style="zoom:67%;" /> 

<img src="C:\java\markdown\docs\img\MySQL\wpsAF4E.tmp.jpg" alt="img" style="zoom:67%;" /> 
...
**优化步骤2**：记录上次返回的主键， 在**下次查询时使用主键过滤**。（说明：避免了数据量大时扫描过多的记录）
